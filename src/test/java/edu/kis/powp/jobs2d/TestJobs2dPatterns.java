...
import edu.kis.powp.jobs2d.drivers.adapter.DrawerControllerAdapter;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		AbstractDriverAdapter figureJaneAdapter = new AbstractDriverAdapter(0, 0);
		application.addTest("Figure Jane", e -> FiguresJane.figureScript(figureJaneAdapter));
	}
